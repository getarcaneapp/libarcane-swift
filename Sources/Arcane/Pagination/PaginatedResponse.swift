...
public struct ArcanePaginator<Element: Decodable & Sendable>: AsyncSequence, Sendable {
  ...
  private let fetch:
    @Sendable (_ start: Int, _ limit: Int) async throws -> PaginatedResponse<Element>

  public init(
    limit: Int = 50,
    fetch:
      @escaping @Sendable (_ start: Int, _ limit: Int) async throws -> PaginatedResponse<Element>
  ) {
