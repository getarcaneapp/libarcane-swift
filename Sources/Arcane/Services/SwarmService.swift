...
public struct SwarmService: Sendable {
    ...
    public func initSwarm(_ request: SwarmInitRequest, envID: EnvironmentID? = nil) async throws -> SwarmInitResponse {
    ...
    public func leave(force: Bool = false, envID: EnvironmentID? = nil) async throws {
        try await rest.postVoid(rest.environmentPath(envID, "swarm/leave"), body: SwarmLeaveRequest(force: force))
    }

    /// Unlocks the swarm using the provided unlock key.
    public func unlock(key: String, envID: EnvironmentID? = nil) async throws {
        try await rest.postVoid(rest.environmentPath(envID, "swarm/unlock"), body: SwarmUnlockRequest(key: key))
    }
    ...
    public func rotateJoinTokens(_ request: SwarmRotateJoinTokensRequest, envID: EnvironmentID? = nil) async throws {
    ...
    public func service(_ serviceId: String, envID: EnvironmentID? = nil) async throws -> SwarmServiceInspect {
    ...
    public func rollbackService(_ serviceId: String, envID: EnvironmentID? = nil) async throws -> SwarmServiceUpdateResponse {
        try await rest.post(rest.environmentPath(envID, "swarm/services/\(serviceId)/rollback"), body: Optional<EmptyBody>.none)
    }
    ...
    public func updateNode(_ nodeId: String, _ request: SwarmNodeUpdateRequest, envID: EnvironmentID? = nil) async throws {
    ...
    public func deleteNode(_ nodeId: String, force: Bool = false, envID: EnvironmentID? = nil) async throws {
    ...
    public func deployStack(_ request: SwarmStackDeployRequest, envID: EnvironmentID? = nil) async throws -> SwarmStackDeployResponse {
    ...
    public func stackSource(_ name: String, envID: EnvironmentID? = nil) async throws -> SwarmStackSource {
    ...
    public func config(_ configId: String, envID: EnvironmentID? = nil) async throws -> SwarmConfigSummary {
        try await rest.get(rest.environmentPath(envID, "swarm/configs/\(configId)"))
    }

    /// Creates a new swarm config.
    public func createConfig(_ request: SwarmConfigCreateRequest, envID: EnvironmentID? = nil) async throws -> SwarmConfigSummary {
    ...
    public func secret(_ secretId: String, envID: EnvironmentID? = nil) async throws -> SwarmSecretSummary {
        try await rest.get(rest.environmentPath(envID, "swarm/secrets/\(secretId)"))
    }

    /// Creates a new swarm secret.
    public func createSecret(_ request: SwarmSecretCreateRequest, envID: EnvironmentID? = nil) async throws -> SwarmSecretSummary {
