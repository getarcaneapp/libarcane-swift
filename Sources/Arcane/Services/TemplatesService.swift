...
public struct TemplatesService: Sendable {
    ...
    public func updateGlobalVariables(_ variables: [EnvVariable], envID: EnvironmentID? = nil) async throws {
        try await rest.putVoid(rest.environmentPath(envID, "templates/variables"), body: EnvVariables(variables: variables))
    }
}
